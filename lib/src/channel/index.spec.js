...
describe('test ticket generation and verification', function () {
    ...
    it('should create a valid ticket', async function () {
        ...
        assert_1.default.deepEqual(await ticket.signer, hoprPolkadot.self.publicKey, `Check that signer is recoverable`);
        ...
        assert_1.default.deepEqual(signedChannel.signer, hoprPolkadot.self.publicKey, `Check that signer is recoverable.`);
