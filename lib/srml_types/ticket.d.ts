...
declare class Ticket extends Ticket_base implements Types.Ticket {
    ...
    static verify(channel: ChannelInstance, signedTicket: Types.SignedTicket<Ticket, Signature>): Promise<boolean>;
    static submit(channel: ChannelInstance, signedTicket: Types.SignedTicket<Ticket, Signature>): Promise<void>;
}
export { Ticket };
