 ...
 */
export declare function isPartyA(initiator: Types.AccountId, counterparty: Types.AccountId): boolean;
/**
 ...
 */
export declare function u8aToHex(arr: Uint8Array, prefixed?: boolean): string;
